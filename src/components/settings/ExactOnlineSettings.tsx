...
import { FileSpreadsheet, ExternalLink, Loader2, CheckCircle2, XCircle, RefreshCw } from 'lucide-react';
...
const ExactOnlineSettings = () => {
  ...
  const registerMutation = useMutation({
    ...
    onSuccess: (data) => {
      ...
      if (data?.setup_url) {
        const popup = window.open(data.setup_url, 'exact-setup', 'width=600,height=700');
        // Listen for postMessage from setup popup
