...
const copy = {
  ...
  pl: {
    ...
    verifying: 'Sprawdzanie linku...',
    invalidTitle: 'Link jest nieprawidłowy lub wygasł',
    invalidBody: 'Ten link do resetowania jest nieprawidłowy lub wygasł. Poproś o nowy link na ekranie logowania.',
    ...
    saving: 'Zapisywanie...',
    save: 'Zapisz hasło',
    successTitle: 'Hasło zostało zmienione',
    successBody: 'Twoje hasło zostało zmienione. Zaloguj się ponownie przy użyciu nowego hasła.',
  ...
  ro: {
    ...
    invalidBody: 'Acest link de resetare este invalid sau a expirat. Solicită un link nou din ecranul de conectare.',
    toLogin: 'Mergi la conectare',
    ...
    successBody: 'Parola ta a fost schimbată. Conectează-te din nou cu noua parolă.',
