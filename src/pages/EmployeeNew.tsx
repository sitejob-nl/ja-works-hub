...
const EmployeeNew = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      <h1 className="text-2xl font-semibold">Kandidaat in dienst nemen</h1>

      <div className="bg-card rounded-lg border p-6 max-w-3xl">
        {step === 1 && (
          <div className="space-y-4">
            <p className="text-sm font-medium text-muted-foreground">Stap 1: Selecteer een kandidaat</p>
        ...
        {step === 2 && selectedCandidate && (
          <div className="space-y-5">
            <p className="text-sm font-medium text-muted-foreground">Stap 2: Dienstverband gegevens</p>
            ...
            <div className="space-y-1.5"><Label>Medewerkernummer</Label><Input value={form.employee_number} onChange={(e) => setForm(f => ({ ...f, employee_number: e.target.value }))} /></div>
            <div className="space-y-1.5"><Label>Startdatum *</Label><Input type="date" value={form.start_date} onChange={(e) => setForm(f => ({ ...f, start_date: e.target.value }))} /></div>
            ...
            <div className="space-y-1.5"><Label>Contracturen</Label><Input type="number" value={form.contract_hours} onChange={(e) => setForm(f => ({ ...f, contract_hours: e.target.value }))} /></div>
