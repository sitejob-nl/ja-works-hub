                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      {v.requirements && (
                        <p className="text-xs text-muted-foreground mt-1 line-clamp-1">
                          <span className="font-medium">Vereisten:</span> {v.requirements}
                        </p>
                      )}
                      <div className="flex items-center gap-2 mt-2">
                        ...
                        {v.contract_type && (
                          <Badge variant="outline" className="text-xs">{v.contract_type}</Badge>
                        )}
                      </div>
                    </div>
      ...
      <Dialog open={!!applyVacancy} onOpenChange={open => { if (!open) { setApplyVacancy(null); setMotivation(''); } }}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              {applyVacancy?.title} bij {(applyVacancy?.companies as any)?.name}
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-4">
            <div>
