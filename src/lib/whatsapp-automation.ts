...
export const normalizeWhatsAppAutomationSettings = (raw: any): WhatsAppAutomationSettings => {
  ...
  return {
    ...
    sick_report_deadline_time: text(source.sick_report_deadline_time, defaults.sick_report_deadline_time),
    sick_report_after_deadline_task_priority: text(
      source.sick_report_after_deadline_task_priority,
      defaults.sick_report_after_deadline_task_priority,
    ),
    sick_report_confirmation_message: text(source.sick_report_confirmation_message, defaults.sick_report_confirmation_message),
