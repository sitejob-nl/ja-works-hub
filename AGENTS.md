...
Een maandbudget is opt-in per organisatie: elke kalendermaand een nieuwe limiet, zonder stapeling of
meenemen van ongebruikt budget. Zie [docs/ai-accounting.md](docs/ai-accounting.md).
