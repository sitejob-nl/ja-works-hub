...
- Verificatie: **157 echte PostgreSQL-tests** (`scripts/hours-workbook-db-test.py` — 12 nieuwe
  ...
  elf migraties elk tweemaal); **1.541 applicatietests**; lint 0 errors, typecheck en productiebuild groen.
...
- **Tien codereviewrondes vonden zesendertig echte defecten, allemaal gerepareerd** met een test die eerst
  ...
  bij een zeer groot bestand tijd — is een bewuste keuze en staat als zodanig in het contract.
