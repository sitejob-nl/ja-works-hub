...
- Verificatie: **157 echte PostgreSQL-tests** (`scripts/hours-workbook-db-test.py` — 12 nieuwe
  ...
  elf migraties elk tweemaal); **1.540 applicatietests**; lint 0 errors, typecheck en productiebuild groen.
...
- **Negen codereviewrondes vonden vierendertig echte defecten, allemaal gerepareerd** met een test die eerst
  ...
  lezing de aangeleverde waarde is.
